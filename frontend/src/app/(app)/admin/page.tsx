...
export default function AdminDashboard() {
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-slate-400">实时监控平台运行状态(每 5 秒刷新)</p>
      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-3">
        <div className="card p-6 lg:col-span-2">
          <h3 className="mb-4 text-sm font-semibold text-slate-300">近 24 小时生成量</h3>
        ...
        <div className="card p-6">
          <h3 className="mb-4 text-sm font-semibold text-slate-300">任务状态分布</h3>
...
function Stat({
  ...
  return (
    <div className="card relative overflow-hidden p-5">
      ...
      <div className="mb-3 grid h-10 w-10 place-items-center rounded-xl bg-white/5 text-brand-300">
        {icon}
      </div>
